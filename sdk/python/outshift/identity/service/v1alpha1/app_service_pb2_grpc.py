...
class AppServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOasfApp = channel.unary_unary(
                '/outshift.identity.service.v1alpha1.AppService/CreateOasfApp',
                request_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppRequest.SerializeToString,
                response_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppResponse.FromString,
                _registered_method=True)
...
def add_AppServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateOasfApp': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppRequest.FromString,
                    response_serializer=outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppResponse.SerializeToString,
            ),
...
class AppService(object):
    ...
    def CreateOasfApp(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/outshift.identity.service.v1alpha1.AppService/CreateOasfApp',
            outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppRequest.SerializeToString,
            outshift_dot_identity_dot_service_dot_v1alpha1_dot_app__service__pb2.CreateOasfAppResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
