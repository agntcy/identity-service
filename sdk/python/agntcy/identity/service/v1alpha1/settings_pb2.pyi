...
class IssuerSettings(_message.Message):
    __slots__ = ("issuer_id", "idp_type", "duo_idp_settings", "okta_idp_settings", "ory_idp_settings")
    ...
    def __init__(self, issuer_id: _Optional[str] = ..., idp_type: _Optional[_Union[IdpType, str]] = ..., duo_idp_settings: _Optional[_Union[DuoIdpSettings, _Mapping]] = ..., okta_idp_settings: _Optional[_Union[OktaIdpSettings, _Mapping]] = ..., ory_idp_settings: _Optional[_Union[OryIdpSettings, _Mapping]] = ...) -> None: ...
