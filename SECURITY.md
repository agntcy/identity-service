...
`AGNTCY Identity Service` project.
...
The `AGNTCY Identity Service` maintainers take all security issues in the project
seriously. Thank you for improving the security of `AGNTCY Identity Service`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`AGNTCY Identity Service` leverages GitHub's private vulnerability reporting.
