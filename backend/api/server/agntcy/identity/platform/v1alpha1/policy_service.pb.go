...
const file_agntcy_identity_platform_v1alpha1_policy_service_proto_rawDesc = "" +
	...
	"\x05_sizeB\b\n" +
	"\x06_query\"X\n" +
	"\x13CreatePolicyRequest\x12A\n" +
	"\x06policy\x18\x01 \x01(\v2).agntcy.identity.platform.v1alpha1.PolicyR\x06policy\"/\n" +
	...
	"\x04rule\x18\x02 \x01(\v2'.agntcy.identity.platform.v1alpha1.RuleR\x04rule\"F\n" +
	...
	"\tpolicy_id\x18\x01 \x01(\tR\bpolicyId\x12\x17\n" +
	"\arule_id\x18\x02 \x01(\tR\x06ruleId2\xe9\x0e\n" +
	...
	"\tGetPolicy\x123.agntcy.identity.platform.v1alpha1.GetPolicyRequest\x1a).agntcy.identity.platform.v1alpha1.Policy\"F\x92A\x1d\x12\x10Get Policy by Id*\tGetPolicy\x82\xd3\xe4\x93\x02 \x12\x1e/v1alpha1/policies/{policy_id}\x12\xb5\x01\n" +
	"\fCreatePolicy\x126.agntcy.identity.platform.v1alpha1.CreatePolicyRequest\x1a).agntcy.identity.platform.v1alpha1.Policy\"B\x92A\x1d\x12\rCreate Policy*\fCreatePolicy\x82\xd3\xe4\x93\x02\x1c:\x06policy\"\x12/v1alpha1/policies\x12\xc1\x01\n" +
	...
	"\aGetRule\x121.agntcy.identity.platform.v1alpha1.GetRuleRequest\x1a'.agntcy.identity.platform.v1alpha1.Rule\"R\x92A\x19\x12\x0eGet Rule by Id*\aGetRule\x82\xd3\xe4\x93\x020\x12./v1alpha1/policies/{policy_id}/rules/{rule_id}\x12\xbb\x01\n" +
	"\n" +
	"CreateRule\x124.agntcy.identity.platform.v1alpha1.CreateRuleRequest\x1a'.agntcy.identity.platform.v1alpha1.Rule\"N\x92A\x19\x12\vCreate Rule*\n" +
	"CreateRule\x82\xd3\xe4\x93\x02,:\x04rule\"$/v1alpha1/policies/{policy_id}/rules\x12\xc5\x01\n" +
	"\n" +
...
var file_agntcy_identity_platform_v1alpha1_policy_service_proto_depIdxs = []int32{
	...
	12, // 2: agntcy.identity.platform.v1alpha1.CreatePolicyRequest.policy:type_name -> agntcy.identity.platform.v1alpha1.Policy
	12, // 3: agntcy.identity.platform.v1alpha1.UpdatePolicyRequest.policy:type_name -> agntcy.identity.platform.v1alpha1.Policy
	14, // 4: agntcy.identity.platform.v1alpha1.ListRulesResponse.rules:type_name -> agntcy.identity.platform.v1alpha1.Rule
	13, // 5: agntcy.identity.platform.v1alpha1.ListRulesResponse.pagination:type_name -> agntcy.identity.platform.shared.v1alpha1.PagedResponse
	14, // 6: agntcy.identity.platform.v1alpha1.CreateRuleRequest.rule:type_name -> agntcy.identity.platform.v1alpha1.Rule
	14, // 7: agntcy.identity.platform.v1alpha1.UpdateRuleRequest.rule:type_name -> agntcy.identity.platform.v1alpha1.Rule
	1,  // 8: agntcy.identity.platform.v1alpha1.PolicyService.ListPolicies:input_type -> agntcy.identity.platform.v1alpha1.ListPoliciesRequest
	3,  // 9: agntcy.identity.platform.v1alpha1.PolicyService.GetPolicy:input_type -> agntcy.identity.platform.v1alpha1.GetPolicyRequest
	2,  // 10: agntcy.identity.platform.v1alpha1.PolicyService.CreatePolicy:input_type -> agntcy.identity.platform.v1alpha1.CreatePolicyRequest
	4,  // 11: agntcy.identity.platform.v1alpha1.PolicyService.UpdatePolicy:input_type -> agntcy.identity.platform.v1alpha1.UpdatePolicyRequest
	5,  // 12: agntcy.identity.platform.v1alpha1.PolicyService.DeletePolicy:input_type -> agntcy.identity.platform.v1alpha1.DeletePolicyRequest
	7,  // 13: agntcy.identity.platform.v1alpha1.PolicyService.ListRules:input_type -> agntcy.identity.platform.v1alpha1.ListRulesRequest
	9,  // 14: agntcy.identity.platform.v1alpha1.PolicyService.GetRule:input_type -> agntcy.identity.platform.v1alpha1.GetRuleRequest
	8,  // 15: agntcy.identity.platform.v1alpha1.PolicyService.CreateRule:input_type -> agntcy.identity.platform.v1alpha1.CreateRuleRequest
	10, // 16: agntcy.identity.platform.v1alpha1.PolicyService.UpdateRule:input_type -> agntcy.identity.platform.v1alpha1.UpdateRuleRequest
	11, // 17: agntcy.identity.platform.v1alpha1.PolicyService.DeleteRule:input_type -> agntcy.identity.platform.v1alpha1.DeleteRuleRequest
	0,  // 18: agntcy.identity.platform.v1alpha1.PolicyService.ListPolicies:output_type -> agntcy.identity.platform.v1alpha1.ListPoliciesResponse
	12, // 19: agntcy.identity.platform.v1alpha1.PolicyService.GetPolicy:output_type -> agntcy.identity.platform.v1alpha1.Policy
	12, // 20: agntcy.identity.platform.v1alpha1.PolicyService.CreatePolicy:output_type -> agntcy.identity.platform.v1alpha1.Policy
	12, // 21: agntcy.identity.platform.v1alpha1.PolicyService.UpdatePolicy:output_type -> agntcy.identity.platform.v1alpha1.Policy
	15, // 22: agntcy.identity.platform.v1alpha1.PolicyService.DeletePolicy:output_type -> google.protobuf.Empty
	6,  // 23: agntcy.identity.platform.v1alpha1.PolicyService.ListRules:output_type -> agntcy.identity.platform.v1alpha1.ListRulesResponse
	14, // 24: agntcy.identity.platform.v1alpha1.PolicyService.GetRule:output_type -> agntcy.identity.platform.v1alpha1.Rule
	14, // 25: agntcy.identity.platform.v1alpha1.PolicyService.CreateRule:output_type -> agntcy.identity.platform.v1alpha1.Rule
	14, // 26: agntcy.identity.platform.v1alpha1.PolicyService.UpdateRule:output_type -> agntcy.identity.platform.v1alpha1.Rule
	15, // 27: agntcy.identity.platform.v1alpha1.PolicyService.DeleteRule:output_type -> google.protobuf.Empty
