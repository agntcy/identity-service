...
type VerifiableCredential struct {
	...
	CredentialSchemas []*CredentialSchema `protobuf:"bytes,8,rep,name=credential_schemas,json=credentialSchemas,proto3" json:"credential_schemas,omitempty"`
...
func (x *VerifiableCredential) GetContexts() []string {
	if x != nil {
		return x.Contexts
	}
	return nil
...
func (x *VerifiableCredential) GetTypes() []string {
	if x != nil {
		return x.Types
	}
	return nil
...
func (x *VerifiableCredential) GetCredentialSchemas() []*CredentialSchema {
	if x != nil {
...
const file_agntcy_identity_platform_v1alpha1_badge_proto_rawDesc = "" +
	...
	"\f_proof_value\"\xb8\x04\n" +
	"\x14VerifiableCredential\x12\x1a\n" +
	"\bcontexts\x18\x01 \x03(\tR\bcontexts\x12\x14\n" +
	...
	"\x0fexpiration_date\x18\a \x01(\tH\x04R\x0eexpirationDate\x88\x01\x01\x12b\n" +
	"\x12credential_schemas\x18\b \x03(\v23.agntcy.identity.platform.v1alpha1.CredentialSchemaR\x11credentialSchemas\x12C\n" +
...
var file_agntcy_identity_platform_v1alpha1_badge_proto_depIdxs = []int32{
	...
	3, // 2: agntcy.identity.platform.v1alpha1.VerifiableCredential.credential_schemas:type_name -> agntcy.identity.platform.v1alpha1.CredentialSchema
