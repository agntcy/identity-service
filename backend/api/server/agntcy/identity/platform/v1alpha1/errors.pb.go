...
const file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc = "" +
	...
	"\"ERROR_REASON_ID_ALREADY_REGISTERED\x10\fBkZigithub.com/agntcy/identity-platform/api/server/agntcy/identity/platform/v1alpha1;identity_platform_sdk_gob\x06proto3"
