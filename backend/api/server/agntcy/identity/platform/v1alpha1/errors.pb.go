...
// 	protoc        (unknown)
// source: agntcy/identity/platform/v1alpha1/errors.proto
...
func (ErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_agntcy_identity_platform_v1alpha1_errors_proto_enumTypes[0].Descriptor()
}

func (ErrorReason) Type() protoreflect.EnumType {
	return &file_agntcy_identity_platform_v1alpha1_errors_proto_enumTypes[0]
}
...
func (ErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescGZIP(), []int{0}
}
...
type ErrorInfo struct {
	...
	// the error.
	Reason *ErrorReason `protobuf:"varint,1,opt,name=reason,proto3,enum=agntcy.identity.platform.v1alpha1.ErrorReason,oneof" json:"reason,omitempty"`
...
func (x *ErrorInfo) Reset() {
	*x = ErrorInfo{}
	mi := &file_agntcy_identity_platform_v1alpha1_errors_proto_msgTypes[0]
...
var File_agntcy_identity_platform_v1alpha1_errors_proto protoreflect.FileDescriptor

const file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc = "" +
	"\n" +
	".agntcy/identity/platform/v1alpha1/errors.proto\x12!agntcy.identity.platform.v1alpha1\"\x8e\x01\n" +
	"\tErrorInfo\x12K\n" +
	"\x06reason\x18\x01 \x01(\x0e2..agntcy.identity.platform.v1alpha1.ErrorReasonH\x00R\x06reason\x88\x01\x01\x12\x1d\n" +
	...
	"*ERROR_REASON_VERIFIABLE_CREDENTIAL_REVOKED\x10\rBkZigithub.com/agntcy/identity-platform/api/server/agntcy/identity/platform/v1alpha1;identity_platform_sdk_gob\x06proto3"

var (
	file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescOnce sync.Once
	file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescData []byte
)

func file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescGZIP() []byte {
	file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescOnce.Do(func() {
		file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc), len(file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc)))
	})
	return file_agntcy_identity_platform_v1alpha1_errors_proto_rawDescData
}

var file_agntcy_identity_platform_v1alpha1_errors_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_agntcy_identity_platform_v1alpha1_errors_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_agntcy_identity_platform_v1alpha1_errors_proto_goTypes = []any{
	(ErrorReason)(0),  // 0: agntcy.identity.platform.v1alpha1.ErrorReason
	(*ErrorInfo)(nil), // 1: agntcy.identity.platform.v1alpha1.ErrorInfo
}
var file_agntcy_identity_platform_v1alpha1_errors_proto_depIdxs = []int32{
	0, // 0: agntcy.identity.platform.v1alpha1.ErrorInfo.reason:type_name -> agntcy.identity.platform.v1alpha1.ErrorReason
...
func init() { file_agntcy_identity_platform_v1alpha1_errors_proto_init() }
func file_agntcy_identity_platform_v1alpha1_errors_proto_init() {
	if File_agntcy_identity_platform_v1alpha1_errors_proto != nil {
		return
	}
	file_agntcy_identity_platform_v1alpha1_errors_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc), len(file_agntcy_identity_platform_v1alpha1_errors_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_agntcy_identity_platform_v1alpha1_errors_proto_goTypes,
		DependencyIndexes: file_agntcy_identity_platform_v1alpha1_errors_proto_depIdxs,
		EnumInfos:         file_agntcy_identity_platform_v1alpha1_errors_proto_enumTypes,
		MessageInfos:      file_agntcy_identity_platform_v1alpha1_errors_proto_msgTypes,
	}.Build()
	File_agntcy_identity_platform_v1alpha1_errors_proto = out.File
	file_agntcy_identity_platform_v1alpha1_errors_proto_goTypes = nil
	file_agntcy_identity_platform_v1alpha1_errors_proto_depIdxs = nil
}
