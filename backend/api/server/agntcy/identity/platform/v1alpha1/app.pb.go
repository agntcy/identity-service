...
type App struct {
	...
	// The type of the App.
	Type          AppType `protobuf:"varint,4,opt,name=type,proto3,enum=agntcy.identity.platform.v1alpha1.AppType" json:"type,omitempty"`
...
const file_agntcy_identity_platform_v1alpha1_app_proto_rawDesc = "" +
	"\n" +
	"+agntcy/identity/platform/v1alpha1/app.proto\x12!agntcy.identity.platform.v1alpha1\x1a\x1fgoogle/api/field_behavior.proto\"\xb3\x01\n" +
	"\x03App\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x03 \x01(\tH\x01R\vdescription\x88\x01\x01\x12>\n" +
	"\x04type\x18\x04 \x01(\x0e2*.agntcy.identity.platform.v1alpha1.AppTypeR\x04typeB\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_description*m\n" +
	"\aAppType\x12\x18\n" +
