...
const file_agntcy_identity_platform_v1alpha1_settings_proto_rawDesc = "" +
	"\n" +
	"0agntcy/identity/platform/v1alpha1/settings.proto\x12!agntcy.identity.platform.v1alpha1\x1a.agntcy/identity/platform/v1alpha1/device.proto\"2\n" +
	"\x06ApiKey\x12\x1c\n" +
...
var file_agntcy_identity_platform_v1alpha1_settings_proto_depIdxs = []int32{
	...
	6, // 5: agntcy.identity.platform.v1alpha1.Settings.devices:type_name -> agntcy.identity.platform.v1alpha1.Device
