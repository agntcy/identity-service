...
func (UnimplementedAppServiceServer) GetAppsCount(context.Context, *GetAppsCountRequest) (*GetAppsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAppsCount not implemented")
}
...
func (UnimplementedAppServiceServer) CreateOasfApp(context.Context, *CreateOasfAppRequest) (*CreateOasfAppResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOasfApp not implemented")
}
...
func (UnimplementedAppServiceServer) RefreshAppApiKey(context.Context, *RefreshAppApiKeyRequest) (*App, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshAppApiKey not implemented")
}
func (UnimplementedAppServiceServer) GetBadge(context.Context, *GetBadgeRequest) (*Badge, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBadge not implemented")
}
