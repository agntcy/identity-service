...
var file_outshift_identity_service_v1alpha1_policy_proto_depIdxs = []int32{
	...
	4, // 2: outshift.identity.service.v1alpha1.Policy.updated_at:type_name -> google.protobuf.Timestamp
	3, // 3: outshift.identity.service.v1alpha1.Rule.tasks:type_name -> outshift.identity.service.v1alpha1.Task
	0, // 4: outshift.identity.service.v1alpha1.Rule.action:type_name -> outshift.identity.service.v1alpha1.RuleAction
	4, // 5: outshift.identity.service.v1alpha1.Rule.created_at:type_name -> google.protobuf.Timestamp
	4, // 6: outshift.identity.service.v1alpha1.Rule.updated_at:type_name -> google.protobuf.Timestamp
