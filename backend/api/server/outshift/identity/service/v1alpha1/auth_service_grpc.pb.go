...
const (
	AuthService_AppInfo_FullMethodName      = "/agoutshift.identity.service.v1alpha1.AuthService/AppInfo"
	AuthService_Authorize_FullMethodName    = "/agoutshift.identity.service.v1alpha1.AuthService/Authorize"
	AuthService_Token_FullMethodName        = "/agoutshift.identity.service.v1alpha1.AuthService/Token"
	AuthService_ExtAuthz_FullMethodName     = "/agoutshift.identity.service.v1alpha1.AuthService/ExtAuthz"
	AuthService_ApproveToken_FullMethodName = "/agoutshift.identity.service.v1alpha1.AuthService/ApproveToken"
)
...
func (c *authServiceClient) AppInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AppInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AppInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ExtAuthz(ctx context.Context, in *ExtAuthzRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_ExtAuthz_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ApproveToken(ctx context.Context, in *ApproveTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AuthService_ApproveToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agoutshift.identity.service.v1alpha1.AuthService",
	...
	Metadata: "outshift/identity/service/v1alpha1/auth_service.proto",
}
