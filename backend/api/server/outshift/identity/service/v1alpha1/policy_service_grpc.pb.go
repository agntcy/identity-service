...
const (
	PolicyService_ListPolicies_FullMethodName     = "/agoutshift.identity.service.v1alpha1.PolicyService/ListPolicies"
	PolicyService_GetPoliciesCount_FullMethodName = "/agoutshift.identity.service.v1alpha1.PolicyService/GetPoliciesCount"
	PolicyService_GetPolicy_FullMethodName        = "/agoutshift.identity.service.v1alpha1.PolicyService/GetPolicy"
	PolicyService_CreatePolicy_FullMethodName     = "/agoutshift.identity.service.v1alpha1.PolicyService/CreatePolicy"
	PolicyService_UpdatePolicy_FullMethodName     = "/agoutshift.identity.service.v1alpha1.PolicyService/UpdatePolicy"
	PolicyService_DeletePolicy_FullMethodName     = "/agoutshift.identity.service.v1alpha1.PolicyService/DeletePolicy"
	PolicyService_ListRules_FullMethodName        = "/agoutshift.identity.service.v1alpha1.PolicyService/ListRules"
	PolicyService_GetRule_FullMethodName          = "/agoutshift.identity.service.v1alpha1.PolicyService/GetRule"
	PolicyService_CreateRule_FullMethodName       = "/agoutshift.identity.service.v1alpha1.PolicyService/CreateRule"
	PolicyService_UpdateRule_FullMethodName       = "/agoutshift.identity.service.v1alpha1.PolicyService/UpdateRule"
	PolicyService_DeleteRule_FullMethodName       = "/agoutshift.identity.service.v1alpha1.PolicyService/DeleteRule"
)
...
func (c *policyServiceClient) GetPoliciesCount(ctx context.Context, in *GetPoliciesCountRequest, opts ...grpc.CallOption) (*GetPoliciesCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, PolicyService_GetPoliciesCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) ListRules(ctx context.Context, in *ListRulesRequest, opts ...grpc.CallOption) (*ListRulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, PolicyService_ListRules_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) GetRule(ctx context.Context, in *GetRuleRequest, opts ...grpc.CallOption) (*Rule, error) {
	out := new(Rule)
	err := c.cc.Invoke(ctx, PolicyService_GetRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) CreateRule(ctx context.Context, in *CreateRuleRequest, opts ...grpc.CallOption) (*Rule, error) {
	out := new(Rule)
	err := c.cc.Invoke(ctx, PolicyService_CreateRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) UpdateRule(ctx context.Context, in *UpdateRuleRequest, opts ...grpc.CallOption) (*Rule, error) {
	out := new(Rule)
	err := c.cc.Invoke(ctx, PolicyService_UpdateRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) DeleteRule(ctx context.Context, in *DeleteRuleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PolicyService_DeleteRule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var PolicyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agoutshift.identity.service.v1alpha1.PolicyService",
	...
	Metadata: "outshift/identity/service/v1alpha1/policy_service.proto",
}
