...
type CredentialStatus struct {
	...
	Purpose       *CredentialStatusPurpose `protobuf:"varint,4,opt,name=purpose,proto3,enum=agoutshift.identity.service.v1alpha1.CredentialStatusPurpose,oneof" json:"purpose,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_outshift_identity_service_v1alpha1_badge_proto_rawDesc = "" +
	...
	"\x05Badge\x12t\n" +
	"\x15verifiable_credential\x18\x01 \x01(\v2:.agoutshift.identity.service.v1alpha1.VerifiableCredentialH\x00R\x14verifiableCredential\x88\x01\x01\x12\x1a\n" +
	...
	"\apurpose\x18\x04 \x01(\x0e2=.agoutshift.identity.service.v1alpha1.CredentialStatusPurposeH\x03R\apurpose\x88\x01\x01B\x05\n" +
	"\x03_idB\a\n" +
	"\x05_typeB\r\n" +
	"\v_created_atB\n" +
	"\n" +
	...
	"\f_proof_value\"\xa0\x05\n" +
	"\x14VerifiableCredential\x12\x18\n" +
	"\acontext\x18\x01 \x03(\tR\acontext\x12\x12\n" +
	"\x04type\x18\x02 \x03(\tR\x04type\x12\x1b\n" +
	"\x06issuer\x18\x03 \x01(\tH\x00R\x06issuer\x88\x01\x01\x12e\n" +
	"\x12credential_subject\x18\x04 \x01(\v21.agoutshift.identity.service.v1alpha1.BadgeClaimsH\x01R\x11credentialSubject\x88\x01\x01\x12\x13\n" +
	"\x02id\x18\x05 \x01(\tH\x02R\x02id\x88\x01\x01\x12(\n" +
	"\rissuance_date\x18\x06 \x01(\tH\x03R\fissuanceDate\x88\x01\x01\x12,\n" +
	"\x0fexpiration_date\x18\a \x01(\tH\x04R\x0eexpirationDate\x88\x01\x01\x12c\n" +
	"\x11credential_schema\x18\b \x03(\v26.agoutshift.identity.service.v1alpha1.CredentialSchemaR\x10credentialSchema\x12c\n" +
	"\x11credential_status\x18\t \x03(\v26.agoutshift.identity.service.v1alpha1.CredentialStatusR\x10credentialStatus\x12F\n" +
	"\x05proof\x18\n" +
	" \x01(\v2+.agoutshift.identity.service.v1alpha1.ProofH\x05R\x05proof\x88\x01\x01B\t\n" +
	"\a_issuerB\x15\n" +
	...
	"\x06status\x18\x01 \x01(\bH\x00R\x06status\x88\x01\x01\x12[\n" +
	"\bdocument\x18\x02 \x01(\v2:.agoutshift.identity.service.v1alpha1.VerifiableCredentialH\x01R\bdocument\x88\x01\x01\x12\"\n" +
	"\n" +
	"media_type\x18\x03 \x01(\tH\x02R\tmediaType\x88\x01\x01\x12#\n" +
	"\n" +
	"controller\x18\x04 \x01(\tH\x03R\n" +
	"controller\x88\x01\x01\x12I\n" +
	"\x1econtrolled_identifier_document\x18\x05 \x01(\tH\x04R\x1ccontrolledIdentifierDocument\x88\x01\x01\x12K\n" +
	"\bwarnings\x18\x06 \x03(\v2/.agoutshift.identity.service.v1alpha1.ErrorInfoR\bwarnings\x12G\n" +
	"\x06errors\x18\a \x03(\v2/.agoutshift.identity.service.v1alpha1.ErrorInfoR\x06errorsB\t\n" +
	"\a_statusB\v\n" +
	"\t_documentB\r\n" +
	"\v_media_typeB\r\n" +
	"\v_controllerB!\n" +
...
var file_outshift_identity_service_v1alpha1_badge_proto_goTypes = []any{
	(BadgeType)(0),                // 0: agoutshift.identity.service.v1alpha1.BadgeType
	(CredentialStatusPurpose)(0),  // 1: agoutshift.identity.service.v1alpha1.CredentialStatusPurpose
	(*Badge)(nil),                 // 2: agoutshift.identity.service.v1alpha1.Badge
	(*BadgeClaims)(nil),           // 3: agoutshift.identity.service.v1alpha1.BadgeClaims
	(*CredentialSchema)(nil),      // 4: agoutshift.identity.service.v1alpha1.CredentialSchema
	(*CredentialStatus)(nil),      // 5: agoutshift.identity.service.v1alpha1.CredentialStatus
	(*ErrorInfo)(nil),             // 6: agoutshift.identity.service.v1alpha1.ErrorInfo
	(*Proof)(nil),                 // 7: agoutshift.identity.service.v1alpha1.Proof
	(*VerifiableCredential)(nil),  // 8: agoutshift.identity.service.v1alpha1.VerifiableCredential
	(*VerificationResult)(nil),    // 9: agoutshift.identity.service.v1alpha1.VerificationResult
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_outshift_identity_service_v1alpha1_badge_proto_depIdxs = []int32{
	8,  // 0: agoutshift.identity.service.v1alpha1.Badge.verifiable_credential:type_name -> agoutshift.identity.service.v1alpha1.VerifiableCredential
	10, // 1: agoutshift.identity.service.v1alpha1.CredentialStatus.created_at:type_name -> google.protobuf.Timestamp
	1,  // 2: agoutshift.identity.service.v1alpha1.CredentialStatus.purpose:type_name -> agoutshift.identity.service.v1alpha1.CredentialStatusPurpose
	3,  // 3: agoutshift.identity.service.v1alpha1.VerifiableCredential.credential_subject:type_name -> agoutshift.identity.service.v1alpha1.BadgeClaims
	4,  // 4: agoutshift.identity.service.v1alpha1.VerifiableCredential.credential_schema:type_name -> agoutshift.identity.service.v1alpha1.CredentialSchema
	5,  // 5: agoutshift.identity.service.v1alpha1.VerifiableCredential.credential_status:type_name -> agoutshift.identity.service.v1alpha1.CredentialStatus
	7,  // 6: agoutshift.identity.service.v1alpha1.VerifiableCredential.proof:type_name -> agoutshift.identity.service.v1alpha1.Proof
	8,  // 7: agoutshift.identity.service.v1alpha1.VerificationResult.document:type_name -> agoutshift.identity.service.v1alpha1.VerifiableCredential
	6,  // 8: agoutshift.identity.service.v1alpha1.VerificationResult.warnings:type_name -> agoutshift.identity.service.v1alpha1.ErrorInfo
	6,  // 9: agoutshift.identity.service.v1alpha1.VerificationResult.errors:type_name -> agoutshift.identity.service.v1alpha1.ErrorInfo
