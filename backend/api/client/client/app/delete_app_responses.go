...
func (o *DeleteAppOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1alpha1/apps/{appId}][%d] deleteAppOK %s", 200, payload)
}
...
func (o *DeleteAppOK) GetPayload() any {
	return o.Payload
}
...
func (o *DeleteAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1alpha1/apps/{appId}][%d] DeleteApp default %s", o._statusCode, payload)
}
