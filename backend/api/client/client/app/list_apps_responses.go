...
func (o *ListAppsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
type ListAppsOK struct {
	Payload *models.V1alpha1ListAppsResponse
}
...
func (o *ListAppsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1alpha1/apps][%d] listAppsOK %s", 200, payload)
}
...
func (o *ListAppsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1alpha1/apps][%d] ListApps default %s", o._statusCode, payload)
}
