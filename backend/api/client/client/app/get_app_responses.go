...
func (o *GetAppOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1alpha1/apps/{appId}][%d] getAppOK %s", 200, payload)
}
...
func (o *GetAppOK) GetPayload() *models.V1alpha1App {
	return o.Payload
}
...
func (o *GetAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1alpha1/apps/{appId}][%d] GetApp default %s", o._statusCode, payload)
}
