...
func (o *CreateAppOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1alpha1/apps][%d] createAppOK %s", 200, payload)
}
...
func (o *CreateAppOK) GetPayload() *models.V1alpha1App {
	return o.Payload
}
...
func (o *CreateAppDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1alpha1/apps][%d] CreateApp default %s", o._statusCode, payload)
}
