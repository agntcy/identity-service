...
func (o *UpdatePolicyParams) WithBody(body *models.PolicyServiceUpdatePolicyBody) *UpdatePolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update policy params
func (o *UpdatePolicyParams) SetBody(body *models.PolicyServiceUpdatePolicyBody) {
	o.Body = body
}
