...
func (o *CreateRuleParams) WithBody(body *models.PolicyServiceCreateRuleBody) *CreateRuleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create rule params
func (o *CreateRuleParams) SetBody(body *models.PolicyServiceCreateRuleBody) {
	o.Body = body
}
