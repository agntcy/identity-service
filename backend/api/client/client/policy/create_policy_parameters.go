...
func (o *CreatePolicyParams) WithBody(body *models.V1alpha1CreatePolicyRequest) *CreatePolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create policy params
func (o *CreatePolicyParams) SetBody(body *models.V1alpha1CreatePolicyRequest) {
	o.Body = body
}
