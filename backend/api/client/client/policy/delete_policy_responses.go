...
func (o *DeletePolicyOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1alpha1/policies/{policyId}][%d] deletePolicyOK %s", 200, payload)
}
...
func (o *DeletePolicyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1alpha1/policies/{policyId}][%d] DeletePolicy default %s", o._statusCode, payload)
}
