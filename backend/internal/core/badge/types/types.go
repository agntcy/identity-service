...
func (err ErrorInfo) Error() string {
	return fmt.Sprintf("%s (reason: %s)", err.Message, err.Reason)
}
...
type VerificationResult struct {
	...
	ControlledIdentifierDocument string `json:"controlledIdentifierDocument" protobuf:"bytes,5,opt,name=controlled_identifier_document"` //nolint:lll // ignore the line length limit

	// A list represents zero or more warnings generated by the verification process
	Warnings []*ErrorInfo `json:"warnings" protobuf:"bytes,6,opt,name=warnings"`

	// A list represents zero or more errors generated by the verification process
	Errors []*ErrorInfo `json:"errors" protobuf:"bytes,7,opt,name=errors"`
}
