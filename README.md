...
- 🌐 Sign up for our hosted SaaS [Identity Service](https://agent-identity.outshift.com/) to try our features.
...
See the [AGNTCY Calendar](https://zoom-lfx.platform.linuxfoundation.org/meetings/agntcy?view=month) for the next Identity WG sessions.
