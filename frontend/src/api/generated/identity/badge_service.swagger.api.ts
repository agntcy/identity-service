...
export interface V1Alpha1ErrorInfo {
  reason?: string;
  message?: string;
}
...
/**
 * @title agntcy/identity/service/v1alpha1/badge_service.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  v1Alpha1 = {
    ...
    verifyBadge: (body: V1Alpha1VerifyBadgeRequest, params: RequestParams = {}) =>
      this.request<V1Alpha1VerificationResult, RpcStatus>({
