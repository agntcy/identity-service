...
// Mock the PolicyApi
vi.mock('../generated/identity/policy_service.swagger.api', () => {
...
// Create a type to extract the class type from the instance for testing
type PolicyAPIClass = typeof PolicyAPI;

describe('PolicyAPIClass', () => {
  let api: PolicyAPIClass;
  ...
  describe('Initialization', () => {
    it('should have correct API methods from v1Alpha1', () => {
      expect(api.createPolicy).toBeDefined();
      expect(api.createRule).toBeDefined();
      expect(api.deletePolicy).toBeDefined();
      expect(api.getPolicy).toBeDefined();
      expect(api.getRule).toBeDefined();
      expect(api.listPolicies).toBeDefined();
      expect(api.listRules).toBeDefined();
      expect(api.updatePolicy).toBeDefined();
      expect(api.updateRule).toBeDefined();
      expect(api.deleteRule).toBeDefined();
      expect(api.getPoliciesCount).toBeDefined();
    });
  });
