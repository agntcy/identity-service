...
vi.mock('../generated/identity/settings_service.swagger.api', () => {
...
type SettingsAPIClass = typeof SettingsAPI;

describe('SettingsAPIClass', () => {
  let api: SettingsAPIClass;
  ...
  describe('Initialization', () => {
    it('should have correct API methods from v1Alpha1', () => {
      ...
      expect(api.setUpIssuer).toBeDefined();
      expect(api.settingsServiceSetApiKey).toBeDefined();
    });
  });
