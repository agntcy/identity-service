...
import * as AgenticServiceApi from '../generated/identity/app_platform.swagger.api';
...
class AgenticServicesAPIClass extends AgenticServiceApi.Api<App> {
  ...
  public deleteApp = this.v1Alpha1.deleteApp;
  public updateApp = this.v1Alpha1.updateApp;
