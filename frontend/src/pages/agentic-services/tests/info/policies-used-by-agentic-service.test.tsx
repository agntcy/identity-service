...
import PoliciesUsedByAgenticService from '../../info/policies-used-by-agentic-service';
...
describe('PoliciesUsedByAgenticService', () => {
  ...
  it('renders without crashing when app is provided', () => {
    ...
    renderWithClient(<PoliciesUsedByAgenticService />);
  ...
  it('renders ListPoliciesAgenticService with correct props', () => {
    ...
    expect(listComponent).toHaveAttribute('data-mode', 'used-by');
  });

  it('returns null when app is not provided', () => {
    mockUseOutletContext.mockReturnValue({});

    const {container} = renderWithClient(<PoliciesUsedByAgenticService />);
  ...
  it('component renders as functional component', () => {
    ...
    const component = renderWithClient(<PoliciesUsedByAgenticService />);
  ...
  it('always passes "used-by" mode to ListPoliciesAgenticService', () => {
    mockUseOutletContext.mockReturnValue({app: mockApp});
