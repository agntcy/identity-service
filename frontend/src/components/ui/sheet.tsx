      ...
      <SheetPortal>
        ...
        <SheetPrimitive.Content
          ...
          className={cn(
            ...
            side === 'left' &&
              'data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm data-[state=closed]:slide-out-to-left',
            side === 'top' &&
        ...
        >
          {children}
          <SheetPrimitive.Close className="absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none hover:cursor-pointer">
