...
*/}}
{{- define "pyramid-backend.fullname" -}}
...
Selector labels
*/}}
{{- define "pyramid-backend.selectorLabels" -}}
app.kubernetes.io/name: {{ include "pyramid-backend.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
